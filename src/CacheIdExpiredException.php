...
class CacheIdExpiredException extends Exception
{
    protected $cacheId;
    ...
    public function __construct(string $cacheId) {
        ...
        parent::__construct("stale cache for '{$cacheId}'");
    }
     ...
     * Return the cache ID
     *
     * @param string The ID of the cache entry
     */
